...
First, let’s try using VGG16 to predict what is in an image from
...
![](08_5_transfer_learning_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
Accuracy on our hold-out test set is 60%, improving from 42% in our
